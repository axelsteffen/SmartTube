...
| Plex | Modules + PIN auth + server discovery + library/movie list via PMS; stream service still stub |
...
| 1 | 1.6–1.7 Stream URL / integration test | open (media service still stub) |
