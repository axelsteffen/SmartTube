...
| Plex | Modules + PIN auth + server discovery via plex.tv resources; library/stream services still stubs |
...
| 1 | 1.5–1.7 Library / stream / test | open (HTTP contracts + OpenAPI ready; library/media stubs) |
