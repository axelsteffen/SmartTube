...
│   └── youtubeapi/
├── PlexServiceCore/                (Fork Submodule — Phase 5.4)
...
| 3 | 3.2 PlexBrowsePresenter — libraries as rows | done |
...
| 5 | 5.4 Optional: extract to `PlexServiceCore` submodule | done |
